...
const styles = StyleSheet.create({
  ...
  heroBody: { color: `${C.surface}C7` },
  contextRow: { flexDirection: "row", gap: S.sm, marginTop: S.xs },
  contextItem: {
    flex: 1,
    borderRadius: RADIUS.button,
    backgroundColor: `${C.surface}14`,
    padding: S.sm,
  },
  contextLabel: { fontFamily: "Inter_600SemiBold", fontSize: 10, color: `${C.surface}8C` },
  ...
  candidateRowSelected: { borderColor: C.saffron, backgroundColor: C.cautionLight },
