...
_SANI_CYCLE_WARN: dict[str, BiText] = {
    ...
    "KANDAKA_SANI":         _bi("கண்டக சனி (ஜென்ம ராசியிலிருந்து) — தடைகளையும் முயற்சிக்கான எதிர்ப்பையும் குறிக்கும் காலம்",
                                "Kantaka Sani (from Janma Rasi) — obstruction and blocked-effort cycle"),
