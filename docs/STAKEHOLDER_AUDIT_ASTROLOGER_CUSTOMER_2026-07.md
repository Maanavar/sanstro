...
| C-2 | 🟡 | **Blunt/archaic Tamil on the panchangam card:** Nethiram renders "குருடு" (blind) and Jeevan "இல்லை" — harsh words for a daily-visible field whose *formula is itself unverified* (A-3). Two independent reasons to soften or hide until verified. | [panchangam.py:250-251](app/calculations/panchangam.py#L250-L251) |
...
4. **A-3 / C-2** — hide or verify Jeevan/Nethiram; soften labels either way.
