...
> **Status:** 🟡 Phase 1 (Today tab) built, awaiting visual sign-off in the browser before Phase 2 starts. Design direction is now the "Nova" look (see [§2](#2-design-source)), an **additive** third theme, not a brand pivot.
