...
const MRIGASHIRA_VISUAL: NatchathiramVisualData = {
  ...
  dashaTimeline: [
    ...
    },
    {
      ...
      detail: {
        expect: "Jupiter dasha from 25 to 41 finds Mrigashira in the fullest expression of creative and intellectual life. Career establishes and deepens — the artist, writer, researcher, or communicator finds their audience. Marriage typically arrives in Jupiter–Mars antardasha (approximately ages 28–30) or Jupiter–Venus (approximately ages 35–37). Children come. Property acquisition becomes feasible in the mid-thirties. Mrigashira's restlessness — which was a disadvantage in youth — becomes an asset in Jupiter dasha: the broad curiosity and cross-domain exploration produces creative work that narrowly specialised people cannot match. Teaching and mentoring impulses emerge.",
