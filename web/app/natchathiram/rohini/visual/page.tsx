...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Visual profile of Rohini Nakshathiram: personality traits, career strengths, dasa timeline, and spiritual guidance.",
...
const ROHINI_VISUAL: NatchathiramVisualData = {
  ...
  dashaTimeline: [
    {
      ...
      detail: {
        expect: "Rohini is born into Moon dasa — the most appropriate opening for a Moon-ruled nakshathiram. From birth, this child is unusually beautiful, responsive to touch and sound, and deeply attuned to the emotional climate of the household. The bond with the mother is among the closest in the zodiac; early childhood is shaped almost entirely by this relationship. The home is the whole world. Creative play — drawing, music, garden, cooking — begins early and naturally. Academic entry (ages 5–10) is gentle; Rohini learns by absorption and environment, not by force. A rich emotional memory is forming in these years that will fuel creative work for decades.",
        navigate: "Moon's shadow on Rohini's birth dasa is excessive sensitivity — this child absorbs every emotional undercurrent in the family. Parental conflict, instability, or neglect leaves impressions that are unusually deep and long-lasting. Digestive health and fluid balance are Moon's primary physical concerns; do not dismiss recurring stomach complaints as minor. Moon–Rahu antardasa (approximately ages 8–9) is the most turbulent sub-period — unusual fears, disturbed sleep, and psychosomatic complaints can cluster here. The mother's own health and emotional stability directly shapes the child's foundation.",
        focus: "Monday worship, Ekadasi fasting, and establishing a stable, beautiful home environment is the most powerful remedy for Moon dasa. Music — singing, listening, or instrument — should be introduced as early as possible; it becomes a lifelong stabiliser. Visiting a sacred water body regularly with the child provides Moon's natural grounding. A stable, loving home is not merely comfort — for Rohini's Moon dasa child, it is medicine.",
      },
    },
    {
      planet: "Mars", period: "7 yrs", ageRange: "Age 10–17", theme: "First Assertion of Self",
      detail: {
        expect: "Mars dasa from 10 to 17 lands Rohini in the full intensity of adolescence. The gentle, creative child of Moon dasa suddenly encounters competition, physical growth, and the demand for independent identity. Academic pressure peaks — board examinations and competitive transitions fall squarely in this window. Athletic ability, previously secondary, may surface as a genuine strength. First romantic stirrings arrive, typically in Mars–Venus antardasa (approximately ages 15–16). The family relationship with siblings and cousins becomes more significant. A first clear career direction usually becomes visible by the end of Mars dasa.",
        navigate: "Mars's energy is sharp in contrast to Rohini's naturally gentle Moon nature — the result can be internal conflict between the desire for beauty and peace and the external demand for competition and assertion. Accidents, impulsive decisions, and conflict with parental authority are the primary risks between ages 10 and 17. Health: inflammatory conditions, skin and eye issues can surface. Do not allow Mars dasa's pressure to permanently redirect a naturally artistic Rohini into purely competitive paths they are not suited for.",
        focus: "Tuesday Murugan worship and physical discipline — sport, martial arts, yoga — channel Mars's energy without letting it damage Rohini's aesthetic nature. Academic excellence and competitive tests are genuinely available in this window; pursue them. Also watch the Mars–Venus antardasa within this dasa (the 7th sub-period, lasting 20 months, beginning approximately in the 5th year of Mars dasa, around age 15). Venus is the lord of your rasi, Rishabam — this window, brief as it is, carries the rasi lord's amplified blessing for Rohini. Creative talent receives unusual public recognition here; romantic connections formed now carry unusual weight; any artistic training intensified in this window tends to become professionally foundational. Do not let Mars's competitive pressure crowd out this sub-period's creative invitation.",
      },
    },
    {
      planet: "Rahu", period: "18 yrs", ageRange: "Age 17–35", theme: "The Magnetic World",
      detail: {
        expect: "Rahu dasa from 17 to 35 is Rohini's most consequential developmental stretch — covering late adolescence, higher education, early career, marriage, and the first decade of full adult life. Rohini's magnetic presence and aesthetic gifts find their first major audiences here. Higher education or vocational training establishes; the creative or hospitality field that becomes a lifelong vocation typically crystallises between ages 20 and 25. Marriage arrives — often in Rahu–Jupiter antardasa (approximately ages 28–30) — and the first child. Rohini's social world expands dramatically under Rahu, drawing in diverse and internationally-influenced connections.",
        navigate: "Rahu amplifies Rohini's natural magnetism to a degree that can attract both opportunity and unwanted attention. Romantic entanglements that are glamorous but unstable are a specific risk in the early portion of this dasa (ages 17–24). Financial discipline is critical — Rohini's love of beauty and abundance can translate into spending patterns that undermine long-term stability. Rahu–Saturn antardasa (approximately ages 30–32) is the most demanding sub-period; career pressures and family responsibilities converge acutely here. Reproductive health for women deserves consistent monitoring throughout this dasa.",
        focus: "Saturday prayers at a Rahu shrine and coconut offerings provide essential grounding. At the dasa's opening (age 17), establishing one clear creative or professional discipline that the entire Rahu period is directed toward yields far better results than opportunistic experimentation. Also note the Rahu–Venus antardasa within this dasa (the 2nd sub-period, lasting 20 months, arriving roughly 18 months into Rahu dasa, around age 18–20). Venus as your rasi lord makes this early window within Rahu dasa the single most important sub-period for Rohini's artistic, romantic, and prosperity foundations. The decisions made in these 20 months — educational direction, creative focus, life partner connection — carry the rasi lord's seal and tend to endure.",
      },
    },
    {
      planet: "Jupiter", period: "16 yrs", ageRange: "Age 35–51", theme: "Prosperity & Purpose",
      detail: {
        expect: "Jupiter dasa from 35 to 51 is Rohini's era of fullest prosperity. Career is established, family is growing, and the creative or business instinct that has been developing finds its most fertile expression. Business ventures — particularly in food, beauty, education, fashion, or hospitality — reach maturity. Property acquisition in the early forties is strongly favoured. Children are entering significant educational milestones and the parent–child relationship deepens into mutual respect. Jupiter brings a natural inclination toward learning, teaching, and community leadership; Rohini's nurturing instinct finds institutional expression in Jupiter dasa.",
        ...
        focus: "Thursday Dakshinamurthy or Vishnu worship amplifies Jupiter's natural abundance for Rohini. This is the single best dasa for Rohini to make property investments and build lasting financial structure. Also note the Jupiter–Venus antardasa within this dasa (the 9th sub-period in Jupiter's sequence, lasting 20 months, arriving approximately in the 9th–10th year of Jupiter dasa, around age 44–46). Venus as rasi lord makes this the most prosperous and creatively fertile sub-period of the entire Jupiter dasa — a window for major creative breakthroughs, significant property acquisition, and relationship deepening that carries the rasi lord's amplification. Plan deliberately for this window from the start of Jupiter dasa.",
      },
    },
    {
      planet: "Saturn", period: "19 yrs", ageRange: "Age 51–70", theme: "The Structure of Maturity",
      detail: {
        expect: "Saturn dasa from 51 to 70 is Rohini's longest period and tests the durability of everything built in earlier dasas. The career structures established in Rahu and Jupiter must now demonstrate their permanence. For those in business, this is the period of institutional consolidation — formalising what was built informally. Children are becoming independent adults; grandchildren begin arriving in the sixties. Rohini's natural patience and long-view orientation aligns well with Saturn's demands, making this dasa more manageable than for many nakshatrams. Legacy-building — charitable work, community involvement, institutional contribution — comes naturally in the late Saturn years.",
        navigate: "Saturn's primary physical warnings for Rohini between 51 and 70 are musculoskeletal, respiratory, and circulatory. Joint care, particularly of knees and hips, requires proactive management. Coldness and emotional distance — Saturn's shadow on Rohini's naturally warm nature — can create friction in family relationships if left unchecked. Saturn–Rahu antardasa (approximately ages 60–62) is the most pressured sub-period; financial and legal obligations that have been deferred will surface with urgency.",
        focus: "Saturday oil bath, Shani temple worship, and service to the elderly are the primary Saturn remedies for Rohini. Also note the Saturn–Venus antardasa within this dasa (approximately in the 10th year of Saturn dasa, around age 61). Venus as rasi lord makes this one of the most significant sub-periods of the entire Saturn dasa — a window of unusual creative and relational warmth within Saturn's generally austere arc. Property matters finalised, creative projects completed, and relationships renewed in this window carry the rasi lord's blessing. Do not let Saturn's general heaviness cause you to overlook this specific opening.",
      },
    },
    {
      planet: "Mercury", period: "17 yrs", ageRange: "Age 70–87", theme: "The Living Garden",
      detail: {
        expect: "Mercury dasa from 70 to 87 finds Rohini in an unexpected flourishing of creative and intellectual expression. The accumulated aesthetic intelligence, storytelling, and creative knowledge of a lifetime produces work that is genuinely irreplaceable — memoirs, teaching, craft mastery, or artistic output that younger practitioners cannot approach. Grandchildren provide a new audience for Rohini's nurturing genius. The home becomes a creative sanctuary. Technology, if embraced in earlier decades, provides new avenues for sharing Rohini's aesthetic gifts with wider audiences.",
        ...
        focus: "Wednesday worship, green offerings, and sustained creative engagement are Mercury's remedies for Rohini. Also note the Mercury–Venus antardasa within this dasa (the 1st sub-period within Mercury dasa, lasting approximately 11 months 27 days, arriving at the very start of Mercury dasa, around age 70). Venus as rasi lord makes this opening window of Mercury dasa a moment of unusual creative and relational grace — the most Venus-touched opening of any late-life dasa. Any significant creative project, relationship renewal, or charitable initiative begun in this first year of Mercury dasa carries the rasi lord's blessing.",
      },
    },
    {
      planet: "Ketu", period: "7 yrs", ageRange: "Age 87–94", theme: "Beautiful Renunciation",
      detail: {
        expect: "Ketu dasa from 87 to 94 calls Rohini into a gentle but unmistakable withdrawal from the world's demands. The person who has spent a lifetime creating, nurturing, and beautifying is invited to experience beauty at its most essential — the beauty of silence, of presence, of being rather than doing. Spiritual deepening, connection with grandchildren and great-grandchildren, and a quiet generosity of spirit characterise this period. Pilgrimage, if physically possible, fulfils a lifetime aspiration.",
        ...
        focus: "Ketu shrine visits, pitru tharpanam, and black sesame offerings are the remedies. The Bhagavata Purana — the story of Krishna, Rohini's own star's divine guest — is the most resonant scriptural companion for this dasa. A prepared, peaceful, and beauty-surrounded completion is the goal.",
      },
    },
    {
      planet: "Venus", period: "20 yrs", ageRange: "Age 94–114", theme: "The Rasi Lord's Final Bloom",
      detail: {
        expect: "Venus dasa from 94 onward is reached by very few, but for those who arrive here, it carries an extraordinary quality: Venus is the lord of your rasi, Rishabam — this makes her dasa doubly charged for Rohini natives. Where other nakshathirams experience Venus dasa as one planetary period among many, for Rohini it is the rasi lord herself arriving in the final chapter. A late-life flowering of beauty, grace, and creative fullness is the classical promise of this period. The person lives in a state of natural abundance — receiving care, appreciation, and the love of family — that mirrors in miniature the Venusian gift they gave to the world across their entire life.",
        ...
        focus: "Friday worship of Goddess Lakshmi, rose and jasmine offerings, and surrounding the person with music, flowers, and beauty is the most appropriate care and remedy for Venus dasa at this age. A life of creating beauty, nurturing others, and honouring the natural world culminates in this gentle return to the Goddess herself.",
      },
    },
  ],
  ...
  guidance: "Your gift is creation — honour it by building things that last. Cultivate beauty, nourish people, invest in patience, and the Venusian abundance that is Rohini's birthright will arrive in every dasa that matters.",

  compatibleEn: ["Aswini", "Bharani", "Hastham", "Uthiram", "Mirugaseeridam"],
