        ...
        <section className="cl-cta-strip">
          <div className="cl-container cl-cta-strip__inner">
            <div>
              ...
              <p className="cl-cta-strip__body">{lang === "en" ? "Create a free account for the full chart-grade porutham report: traditional 10-factor Thirukanitham score, Rajju / Vedhai, Nadi judgement, Sevvai dosham, D9, dasha context, saved family members, and daily guidance." : "முழு ஜாதக அடிப்படையிலான பொருத்த அறிக்கைக்கு இலவச கணக்கை உருவாக்குங்கள்: 10-கூறு திருக்கணித மதிப்பெண், ரஜ்ஜு / வேதை, நாடி தீர்வு, செவ்வாய் தோஷம், நவாம்சம், தசை சூழல், குடும்ப உறுப்பினர் சேமிப்பு, தினசரி வழிகாட்டுதல்."}</p>
            </div>
