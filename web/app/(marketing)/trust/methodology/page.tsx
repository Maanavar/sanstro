          ...
          <div className="cl-container">
            <div className="cl-article">
              ...
              <div className="cl-article__body cl-trust-prose">
                ...
                <p>{lang === "en"
                  ? "Why panchangam apps sometimes disagree: Vinaadi uses Thirukanitham — the Drik-ganita (ephemeris-based) method — for every tithi, nakshatra, yoga, and karana boundary. Many temple wall-calendars and family purohits still follow the older Vakya (tabular/rule-based) tradition, which can place a boundary a few minutes to a few hours away from the Drik-computed time, especially when a limb changes close to sunrise or midnight. Both are legitimate, long-standing systems — the difference is method, not error. If your almanac shows a different tithi or nakshatra for the day, check the exact end time shown on your panchangam screen; that is usually where the two methods diverge."
                  : "பஞ்சாங்க செயலிகள் சில நேரம் ஏன் வேறுபடுகின்றன: விநாடி ஒவ்வொரு திதி, நட்சத்திரம், யோகம், கரண மாற்ற நேரத்திற்கும் திருக்கணிதம் — எபிமெரிஸ் அடிப்படையிலான திரிக் முறையைப் பயன்படுத்துகிறது. பல கோவில் சுவரொட்டி பஞ்சாங்கங்களும் குடும்ப குருமார்களும் இன்னும் பழைய வாக்கிய (அட்டவணை அடிப்படையிலான) முறையைப் பின்பற்றுகின்றனர்; இது திரிக் கணக்கிட்ட நேரத்திலிருந்து சில நிமிடங்கள் முதல் சில மணி நேரம் வரை வேறுபடலாம் — குறிப்பாக ஒரு அங்கம் சூரிய உதயம் அல்லது நள்ளிரவுக்கு அருகில் மாறும்போது. இரண்டுமே செல்லுபடியான, நீண்டகால முறைகளே — வேறுபாடு தவறு அல்ல, முறையில் உள்ள வேறுபாடே. உங்கள் பஞ்சாங்கத்தில் வேறு திதி அல்லது நட்சத்திரம் காட்டினால், உங்கள் பஞ்சாங்கத் திரையில் உள்ள சரியான முடிவு நேரத்தை சரிபார்க்கவும்; பொதுவாக அங்குதான் இரு முறைகளும் வேறுபடுகின்றன."}</p>
