...
import { DOSHAM_KALATHRA, DOSHAM_KALATHRA_FAQ, mt } from "@/lib/marketing-i18n";
...
export async function KalathraDoshamContent() {
  const lang = await getServerLang();
  const d = DOSHAM_KALATHRA;
  ...
  return (
    <div className="clarity-shell">
      ...
      <main>
        ...
        <section className="cl-band cl-band--alt">
          <div className="cl-container">
            <FaqSection items={DOSHAM_KALATHRA_FAQ} />
            ...
            <div className="cl-pub-related" style={{ marginTop: "2rem" }}>
              ...
              <div className="cl-pub-related-links">
                <Link href="/dosham/sevvai-dosham" className="cl-pub-related-link">{lang === "en" ? "Sevvai Dosham →" : "செவ்வாய் தோஷம் →"}</Link>
                ...
                <Link href="/pariharam/thirumana-thadai" className="cl-pub-related-link">{lang === "en" ? "Pariharam for marriage delay →" : "திருமணத் தடைக்கான பரிகாரம் →"}</Link>
              </div>
            </div>
