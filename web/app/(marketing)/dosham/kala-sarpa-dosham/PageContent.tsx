...
import { DOSHAM_KALA_SARPA, DOSHAM_KALA_SARPA_FAQ, mt } from "@/lib/marketing-i18n";
...
export async function KalaSarpaDoshamContent() {
  const lang = await getServerLang();
  const d = DOSHAM_KALA_SARPA;
  ...
  return (
    <div className="clarity-shell">
      ...
      <main>
        ...
        <section className="cl-band cl-band--alt">
          <div className="cl-container">
            <FaqSection items={DOSHAM_KALA_SARPA_FAQ} />
