...
import { PARIHARAM_PUTHRA, PARIHARAM_PUTHRA_FAQ, mt } from "@/lib/marketing-i18n";
...
export async function PuthraPariharamContent() {
  const lang = await getServerLang();
  const d = PARIHARAM_PUTHRA;
        ...
        <section className="cl-band cl-band--alt">
          <div className="cl-container">
            <div style={{ marginBottom: "2.5rem" }}>
              <FaqSection items={PARIHARAM_PUTHRA_FAQ} />
            </div>
            ...
            <div className="cl-pub-related" style={{ marginTop: "2rem" }}>
              ...
              <div className="cl-pub-related-links">
                ...
                <Link href="/temples/thirumananjeri" className="cl-pub-related-link">
                  {lang === "en" ? "Thirumananjeri — marriage blessings temple →" : "திருமணஞ்சேரி — திருமண ஆசீர்வாத கோயில் →"}
                </Link>
              </div>
            </div>
