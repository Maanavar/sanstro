...
import { PARIHARAM_AYUL, PARIHARAM_AYUL_FAQ, mt } from "@/lib/marketing-i18n";
...
export async function AyulPariharamContent() {
  const lang = await getServerLang();
  const d = PARIHARAM_AYUL;
        ...
        <section className="cl-band cl-band--alt">
          <div className="cl-container">
            <div style={{ marginBottom: "2.5rem" }}>
              <FaqSection items={PARIHARAM_AYUL_FAQ} />
            </div>
            ...
            <div className="cl-pub-related" style={{ marginTop: "2rem" }}>
              ...
              <div className="cl-pub-related-links">
                ...
                <Link href="/temples/suryanar-koil" className="cl-pub-related-link">
                  {lang === "en" ? "Suryanar Koil — Sun temple →" : "சூரியனார் கோயில் →"}
                </Link>
                <Link href="/temples/pancha-bhoota-sthalams" className="cl-pub-related-link">
                  {lang === "en" ? "Pancha Bhoota Sthalams →" : "பஞ்ச பூத ஸ்தலங்கள் →"}
                </Link>
              </div>
            </div>
