...
import { PARIHARAM_NAGA, PARIHARAM_NAGA_FAQ, mt } from "@/lib/marketing-i18n";
...
export async function NagaDoshaPariharamContent() {
  const lang = await getServerLang();
  const d = PARIHARAM_NAGA;
        ...
        <section className="cl-band cl-band--alt">
          <div className="cl-container">
            <div style={{ marginBottom: "2.5rem" }}>
              <FaqSection items={PARIHARAM_NAGA_FAQ} />
            </div>
            ...
            <div className="cl-pub-related" style={{ marginTop: "2rem" }}>
              ...
              <div className="cl-pub-related-links">
                <Link href="/pariharam/rahu-ketu-pariharam" className="cl-pub-related-link">
                  {lang === "en" ? "Rahu-Ketu Pariharam →" : "ராகு-கேது பரிகாரம் →"}
                </Link>
                <Link href="/pariharam/puthra-pariharam" className="cl-pub-related-link">
                  {lang === "en" ? "Pariharam for childbirth blessings →" : "புத்திர பரிகாரம் →"}
                </Link>
