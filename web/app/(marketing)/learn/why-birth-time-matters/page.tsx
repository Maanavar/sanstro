...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Lagna changes every 2 hours and dasa start depends on the Moon's exact birth-star pada. Both require an accurate birth time. Learn why and what to do when time is uncertain.",
...
const FAQ_JSONLD = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Birth time rectification is the process of using life events as reference points — working backwards through the dasa and transit system — to narrow down an uncertain birth time. If major events in your life align with specific dasa periods, the birth time that produces that dasa sequence is likely close to the actual birth time.",
      },
    },
  ],
};
