...
// ORPHANED 2026-08-08 — NOT IMPORTED ANYWHERE. Superseded by
// `dashboard-tools-baby-names-nova.tsx`, which cites this file's documentation
// (and `baby-name-copy.ts:19` cites it too), so the pointers here are live even
// though the component is not. Verified by sweeping every import specifier in
// web/, packages/ and mobile/. Do not fix a bug here — find the file that ships.
