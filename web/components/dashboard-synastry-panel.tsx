            ...
            <>
              ...
              {compatError && (
                <div style={{ padding: "var(--space-3_5) var(--space-4)", borderRadius: "var(--radius-md)", background: "var(--panel-warm-tint)", border: "1px solid var(--border-error-soft)" }}>
                  ...
                  <p style={{ margin: "0 0 var(--space-1_5)", fontSize: "0.75rem", color: "var(--planet-saturn)" }}>{compatError}</p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
          {memberOptions.length === 0 ? (
            ...
            <>
              ...
              {poruthamError && <p style={{ fontSize: "0.875rem", color: "var(--planet-saturn)" }}>{poruthamError}</p>}
                    ...
                    {porutham.kutas.map((k) => {
                      ...
                      return (
                        <div key={k.name} style={{
                          ...
                          {isCriticalFail && (
                            <p style={{ margin: "var(--space-2) 0 0", fontSize: "0.75rem", color: "var(--planet-saturn)", lineHeight: 1.4 }}>
                              {k.name === "Rajju"
