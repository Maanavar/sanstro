...
const STRINGS = {
  ...
  opening_dasha:    { ta: "ஆரம்ப தசை",         en: "Opening dasa" },
  ...
  settings_retention_title: { ta: "குறிப்பு தக்கவைப்பு", en: "Journal retention" },
  settings_retention_desc: { ta: "பழைய குறிப்புகளை எத்தனை நாட்கள் வரை வைக்கவேண்டும் என அமைக்கவும்.", en: "Choose how long journal entries are kept before retention cleanup." },
  settings_retention_days: { ta: "வைக்கும் நாட்கள்", en: "Retention days" },
  settings_retention_hint: { ta: "தக்கவைப்பு செயல்படுத்தும்போது இந்த இயல்புநிலை பயன்படும் (7–3650).", en: "Used as the default when retention apply runs (7–3650)." },
  settings_retention_save: { ta: "சேமி", en: "Save retention" },
  settings_retention_saving: { ta: "சேமிக்கிறது…", en: "Saving…" },
  settings_retention_saved: { ta: "தக்கவைப்பு இயல்புநிலை புதுப்பிக்கப்பட்டது.", en: "Retention default updated." },
  ...
  settings_retention_notice_short: { ta: "குறுகிய காலம்: வேகமாக சுத்தப்படுத்தல். முக்கியமான பழைய குறிப்புகளை காப்பகப்படுத்த/ஏற்றுமதி செய்யவும்.", en: "Short window: cleanup happens faster. Archive/export important older notes." },
  ...
  modal_edit_profile_sub:   { ta: "புதிய பதிவு உருவாகும் — தரவு மீண்டும் கணக்கிடப்படும்", en: "A new profile will be created and data recalculated." },
  ...
  safeguard_reflection:{ ta: "இந்த நாட்குறிப்பு சிந்தனைக்கான இடம் — மனநல சிகிச்சைக்கு மாற்றல்ல. நீங்கள் கடினமான காலத்தைக் கடந்து சென்றால், நீங்கள் நம்பும் ஒருவரையோ அல்லது ஒரு நிபுணரையோ அணுகுங்கள்.", en: "This journal is a space for reflection, not a substitute for mental-health care. If you're going through a hard time, please reach out to someone you trust or a professional." },
  ...
  whatif_panel_desc:   { ta: "ஒரு தேதியும் இலக்கும் தேர்ந்தெடுக்கவும். மூன்று தூண் திருக்கணித முறையில் ஆய்வு கிடைக்கும்.", en: "Pick a scenario and a target date. Get a triple-confirmation Thirukanitham analysis." },
  ...
  remedies_mode_traditional: { ta: "பாரம்பரிய வழிமுறை",         en: "Traditional practice" },
  remedies_mode_secular:   { ta: "மதச்சார்பற்ற செயல்கள்",       en: "Secular actions" },
  remedies_secular_note:   { ta: "ஒவ்வொரு கிரகத்திற்கும் நடத்தை மாற்றமும் சேவை பரிகாரமும் மட்டும் காட்டப்படும் — கோவில், மந்திரம், விரதம், ரத்தினம் இல்லை.", en: "Shows only the behavioural action and the service (seva) action for each planet — no temple, mantra, fasting, or gemstone." },
